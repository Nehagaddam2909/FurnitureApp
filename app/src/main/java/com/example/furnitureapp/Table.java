...
public class Table extends AppCompatActivity {
    ...
    public void model1(View view) {
        setUpModel("tabler.sfb");
        setUpPlane();
    }

    public void model2(View view) {
        setUpModel("ctable.sfb");
        setUpPlane();
    }
...
public void getS(TransformableNode transformableNode)
{

    TransformableNode tm=(TransformableNode) n1.getChildren();
    Log.i("Node",tm.getClass().getSimpleName());
    Box b=(Box) tm.getRenderable().getCollisionShape();
    Vector3 v=b.getSize();
    // Vector3 tra=transformableNode.getWorldScale();
    //Vector3 final1=new Vector3(v.x*tra.x,v.y*tra.y,v.z*tra.z);
    Toast.makeText(getApplicationContext(),v.toString(),Toast.LENGTH_LONG).show();
